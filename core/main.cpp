...
int main() {
    ...
    DEMO:
    1. Show empty memory
    2. Load test.hex into DRAM
    3. Show populated memory and empty cache
    4. Show empty registers
    5. Read from memory (ping WAIT from same and different IDs)
    6. Show updated registers
    7. Read from cache
    8. Write to memory
    9. Show updated memory and cache (write-through)
    */
